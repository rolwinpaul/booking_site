            ...
            {isAccountOpen ? (
              <div className="fixed top-20 rounded-md p-4  z-10 shadow-[0_4px_10px_rgb(0,0,0,0.12)]">
                ...
                <button
                  ...
                  className="bg-red-500 mt-5 hover:bg-red-300 text-white p-3 w-full rounded-md"
                >
                  Log Out
                </button>
              </div>
        ...
        <div className="flex justify-between w-full">
          ...
          {status === "authenticated" ? (
            <div className="flex flex-col justify-center items-end">
              ...
              {isAccountOpen ? (
                <div className="fixed top-20 bg-white text-sm rounded-md p-4 z-10 shadow-[0_4px_10px_rgb(0,0,0,0.12)] ">
                  <div>{data.user?.name}</div>
                  <div>{data.user?.email}</div>
                  <button className="bg-red-500 mt-2 hover:bg-red-300 text-white p-2 w-full rounded-md"onClick={logouthandler}>Log Out</button>
                </div>
              ) : null}
            </div>
          ) : (
